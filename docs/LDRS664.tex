...
\emph{Please see the following rubric your instructor may use to measure your engagement and understanding of the course learning outcomes.}

\begin{itemize}
\tightlist
\item
  \href{assets/assessment/LDRS664_DiscussionRubric.pdf}{Grading Rubric (PDF)}
\end{itemize}

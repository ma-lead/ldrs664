...
\addcontentsline{toc}{section}{Course Units}
...
\hypertarget{course-activities-1}{%
\subsection*{Course Activities}\label{course-activities-1}}
...
\hypertarget{how-to-navigate-this-book-1}{%
\subsection*{How To Navigate This Book}\label{how-to-navigate-this-book-1}}
\addcontentsline{toc}{subsection}{How To Navigate This Book}
...
\begin{reflect}
Take the \href{http://paulineroseclance.com/pdf/IPscoringtest.pdf}{Clance Imposter Phenomenon test}. As you take the test, consider the areas in which you feel vulnerable in your work as a learner. How would you address these concerns for learners in courses you facilitate?
\end{reflect}
...
Optional Read: Cuddy, A. (2016).~\href{https://leanin.org/news-inspiration/overcoming-imposter-syndrome-to-reveal-your-presence}{I don't deserve to be here: Presence and the imposter syndrome}.
\end{reflect}
...
\begin{reflect}
Read \href{assets/unit4/Learning_community.pdf}{``What IS a Learning Community?'' (Brower \& Dettinger, 1998)}.
...
\textbf{As we compare the other two models, feel free to organize your thoughts into a chart such as the following:}
...
\tightlist
\item
  Brookfield, Stephen and Preskill, S. (2016).~\emph{The discussion book: 50 great ways to get people talking}. San Francisco: Jossey Bass.\\
\item

...
| Activity: Review the [“Principles of Appreciative Inquiry”](https://appreciativeinquiry.champlain.edu/learn/appreciative-inquiry-introduction/5-classic-principles-ai)  |
| Activity: Listen: Sarah Bareilles [Brave](https://www.youtube.com/watch?v=QUQsqBqxoR4). Watch: Kalhil KJ Adames [Identity Short Film](https://www.youtube.com/watch?v=ikGVWEvUzNM). Read: Brown, B. (2017) *Braving the Wilderness,* Chapter 7 Strong Back. Soft Front. Wild Heart.|
...
```{block, type='reflect'}
Review the [“Principles of Appreciative Inquiry”](https://appreciativeinquiry.champlain.edu/learn/appreciative-inquiry-introduction/5-classic-principles-ai/) from the Appreciative Inquiry Commons at Champlain University. (Also in Whitney & Trosten-Bloom. (2010). *The power of appreciative inquiry: A practical guide to positive change.*)
